...
namespace OpenERP.Persistence.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PartNum = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: false, defaultValueSql: "('')"),
                    RevisionNum = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false, defaultValueSql: "('')"),
                    CompanyID = table.Column<string>(type: "varchar(8)", maxLength: 8, nullable: false, defaultValueSql: "('')"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartRevision", x => new { x.CompanyID, x.PartNum, x.RevisionNum });
                    table.ForeignKey(
                        name: "FK_PR_Part",
